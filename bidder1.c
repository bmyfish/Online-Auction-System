...
#define bidderudp "3128"
#define biddertcp "4128"
#define MAXDATASIZE 256
#define HOSTNAME "nunki.usc.edu"
#define stop "term"
#define fileid "Bidder#1"
#define bidtxt "bidding1.txt"
#define logintxt "bidderPass1.txt"
#define BACKLOG 10
...
int authentication(char *read, char *filename)
{
    ...
    /*
	 * L59 to L100 are from the given tutorial http://beej.us/guide/bgnet/.
	 */
	/* create socket */
...
int Auction(char *inputfilename,char *biddername){
    ...
    /*
	 * L221 to L243 are from the given tutorial http://beej.us/guide/bgnet/.
	 */
	/* create socket */
   ...
   // printf("ip  %s  port:%d\n",inet_ntoa(client.sin_addr),theirport);
    ...
    /*
	 * L342 to L380 are from the given tutorial http://beej.us/guide/bgnet/.
	 */
	/* create socket */
